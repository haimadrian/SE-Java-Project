...
public interface Logger {
    ...
    * @param messageSupplier A function, which when called, produces the desired log message; the format depends on the message factory.
    */
   default void trace(Supplier<CharSequence> messageSupplier) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void trace(Supplier<CharSequence> messageSupplier, Throwable thrown) {
      log(Level.TRACE, messageSupplier, thrown);
   }
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void trace(CharSequence message, Throwable thrown) {
    ...
    * @param messageSupplier A function, which when called, produces the desired log message; the format depends on the message factory.
    */
   default void debug(Supplier<CharSequence> messageSupplier) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void debug(Supplier<CharSequence> messageSupplier, Throwable thrown) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void debug(CharSequence message, Throwable thrown) {
    ...
    * @param messageSupplier A function, which when called, produces the desired log message; the format depends on the message factory.
    */
   default void info(Supplier<CharSequence> messageSupplier) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void info(Supplier<CharSequence> messageSupplier, Throwable thrown) {
      log(Level.INFO, messageSupplier, thrown);
   }
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void info(CharSequence message, Throwable thrown) {
    ...
    * @param messageSupplier A function, which when called, produces the desired log message; the format depends on the message factory.
    */
   default void warn(Supplier<CharSequence> messageSupplier) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void warn(Supplier<CharSequence> messageSupplier, Throwable thrown) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void warn(CharSequence message, Throwable thrown) {
    ...
    * @param messageSupplier A function, which when called, produces the desired log message; the format depends on the message factory.
    */
   default void error(Supplier<CharSequence> messageSupplier) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void error(Supplier<CharSequence> messageSupplier, Throwable thrown) {
      log(Level.ERROR, messageSupplier, thrown);
   }
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void error(CharSequence message, Throwable thrown) {
    ...
    * @param messageSupplier A function, which when called, produces the desired log message; the format depends on the message factory.
    */
   default void fatal(Supplier<CharSequence> messageSupplier) {
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void fatal(Supplier<CharSequence> messageSupplier, Throwable thrown) {
      log(Level.FATAL, messageSupplier, thrown);
   }
    ...
    * @param thrown the exception to log, including its stack trace.
    */
   default void fatal(CharSequence message, Throwable thrown) {
